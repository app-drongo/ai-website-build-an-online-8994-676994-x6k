...
export default function Cta() {
  const stats = [
    { value: "15K+", label: "Professionals Trained", icon: Users },
    { value: "95%", label: "Course Completion Rate", icon: Award },
    { value: "200+", label: "Expert Instructors", icon: BookOpen },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of professionals who have advanced their careers with SkillBridge Academy. 
                Master in-demand skills in data science, digital marketing, and UX design with flexible online learning.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Course Preview</h3>
              <p className="text-sm text-muted-foreground">
                Access sample lessons before you commit
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Industry Certification</h3>
              <p className="text-sm text-muted-foreground">
